        ...
        <div className="grid grid-cols-2 mt-10 mb-10">
          <div className="col-span-1">
            <p className="text-sm text-gray-400">
              ...
              <span className="font-bold text-black">9</span> of{" "}
              <span className="font-bold text-black">100</span> Enteries
            </p>
          </div>

          <div className="col-span-1 flex justify-end">
            <Dropdown label="Default Sorting" dismissOnClick={false}>
              <Dropdown.Item>Bag</Dropdown.Item>
              <Dropdown.Item>Keychain</Dropdown.Item>
              <Dropdown.Item>Bracelet</Dropdown.Item>
            </Dropdown>
          </div>
        </div>
