...
import UserOne from "../images/user-1.jpeg";
  ...
  return (
    <div className="cotainer flex justify-center items-center mt-28">
      <div className="w-10/12">
        ...
        {isMobile ? (
          <div className="grid custom-heigt-corousel mt-10">
            <Carousel>
              <div className="">
                <img
                  src={UserOne}
          ...
          <div className="grid h-56 md:grid-cols-2 gap-4 sm:h-64 xl:h-80 2xl:h-96 mt-10">
            <Carousel>
              <div className="">
                <img
                  src={UserOne}
