...
export default function Footer() {
  return (
    <div className="container custom-bg-color flex justify-center items-center mt-28">
      <div className="w-10/12 px-8 py-14">
          ...
          <div className="col-span-1">
            <div className="grid grid-cols-8">
              ...
              <div className="col-span-6">
                <h5 className="text-white font-bold text-2xl">Liosa Cosplay</h5>
              </div>
            </div>
          </div>
        ...
        <hr className="w-11/12 mx-auto mt-7 mb-4" />

        <div className="grid grid-cols-2 gap-2">
          <div className="col-span-1 flex items-center ml-12">
            <svg
            ...
            <span className="text-white text-sm ml-1">Loisa Cosplay™</span>
          </div>

          <div className="col-span-1 flex items-center justify-end mr-12">
            <svg
              viewBox="0 0 1024 1024"
              fill="currentColor"
              height="1.5em"
